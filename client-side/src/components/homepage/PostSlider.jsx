...
const PostSlider = ({ posts }) => {
  ...
  return (
    <>
    <h2 className="ml-10 text-4xl font-bold mb-4 flex items-center">
      <MousePointerSquareDashedIcon className="mr-3 text-3xl text-red-800 dark:text-yellow-200" />
        Latest Posts
      </h2>
        ...
        >
          ...
          <div className="relative h-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-center">
            ...
            <div className="relative z-10 text-center text-white px-6 py-12">
              <h2 className="text-4xl font-bold mb-4 drop-shadow-lg">{post.title}</h2>
              <p className="text-xl font-semibold mb-4 text-gray-300 drop-shadow-lg">{post.subtitle}</p>
