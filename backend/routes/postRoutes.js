...
router.route("/getPost/:slug").get(optionalAuth, cacheMiddleware(1800), getPostBySlug); // Cache for 30 minutes
...
router.route("/getPosts").get(optionalAuth, cacheMiddleware(600), getPosts); // Cache for 10 minutes
...
router.route("/getFeaturedPosts").get(optionalAuth, cacheMiddleware(1800), getFeaturedPosts); // Cache for 30 minutes
...
router.route("/getCategory/:categorySlug").get(optionalAuth, cacheMiddleware(1800), getCategoryBySlug); // Cache for 30 minutes
